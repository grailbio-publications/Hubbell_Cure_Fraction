#this is identical to the main 03 
#fit full range collapsed data

#set up

#transform data to a form that can be written as part of a file name
local_collapsed_one<-total_collapsed_one %>%
...
system("mkdir generated_data/feather")
system("mkdir reports/pdf")
...
for (ii in 1:length(scan_choice_df$SEER_Draw)){
  ...
  fit_staged_cure_fraction(my_stan_model, my_local_data,date_code,cancer_choice,"total")
