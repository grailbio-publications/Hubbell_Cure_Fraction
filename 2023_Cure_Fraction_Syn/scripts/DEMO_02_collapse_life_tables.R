...
#original data
if (synthetic_flag){
  life_table_data_two<-read_tsv(sprintf("../2023_Synthetic_Cure_Data/generated_data/%s_demo_life_table_data.tsv",input_date_code))
}
...
total_collapsed_one<-life_table_collapsed_one
