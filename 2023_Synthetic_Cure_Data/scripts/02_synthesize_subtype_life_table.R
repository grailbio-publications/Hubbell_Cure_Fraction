...
life_table_original<-read_tsv(sprintf("generated_data/%s_subtype_life_table_data.tsv",date_code))
...
write_tsv(synthetic_two,sprintf("generated_data/%s_synthetic_subtype_life_table_data.tsv",date_code))
